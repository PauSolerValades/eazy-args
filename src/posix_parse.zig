...
pub fn parseArgsErgonomicRecursive(comptime definition: anytype, args: *PeekIterator, ctx: ?*const ContextNode, stdout: *Io.Writer, stderr: *Io.Writer) anyerror!Reify(definition){
